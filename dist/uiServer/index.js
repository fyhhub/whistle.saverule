...
exports.default = (server, options) => {
    ...
    app.use((0, koa_static_1.default)(path_1.default.join(__dirname, '../../tool/dist'), { maxage: MAX_AGE }));
    app.use((0, koa_static_1.default)(path_1.default.join(__dirname, '../../tool/static'), { maxage: MAX_AGE }));
    server.on('request', app.callback());
    (0, storage_1.default)(options);
};
